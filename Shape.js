class Shape {
    ...
    // make a ghost clone this same shape, serving as the ghost piece
    makeGhostClone(){
        this.ghostClone = new Shape(this.shapeID, this.currentPos);
        this.ghostClone.blocks = this.blocks;
        this.ghostClone.hardDrop(false);
    }

    drawGhost(){
        this.makeGhostClone();
        this.ghostClone.draw()
    }
